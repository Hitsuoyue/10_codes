        ...
        const setCarouselInter = () => {
            return setInterval(() => {
                ...
                timeline.add(new Animation(current.style, 'transform', 
                    -100*position, -100*(position + 1), 1000, 0, cubicBezier, v => `translateX(${v}%)`
                ));
    
                timeline.add(new Animation(next.style, 'transform', 
                    -100*(nextIndex - 1), -100*(nextIndex), 1000, 0, cubicBezier, v => `translateX(${v}%)`
                ));
                ...
                //     current.style.transform = `translateX(${-100*(position + 1)}%)`;
